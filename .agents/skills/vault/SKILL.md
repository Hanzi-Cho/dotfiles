...
name: vault
description: >-
  Idea Vault에 프로젝트 아이디어 기획 또는 관심 기술 스택(Tech Radar)을 분석하여 적절한 위치에 규격화하여 기록/갱신합니다.
  입력 텍스트의 양상(아이디어 기획, 관심 기술, 복합)을 판별하고 중복을 엄격히 방지하며 README 자동 동기화까지 수행합니다.
---

<!-- 권장: Antigravity / Claude Code 공용 Idea Vault 자동 기록 워크플로우 -->
